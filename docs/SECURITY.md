...
|--------|-------------|-----------|
| Main channel | Trusted | DM with dedicated Jarvis number, admin control |
...
**External Allowlist** - Mount permissions stored at `~/.config/microclaw/mount-allowlist.json`, which is:
