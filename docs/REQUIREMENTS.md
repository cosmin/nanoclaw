...
MicroClaw gives you the core functionality without that mess.
...
- Custom `microclaw` MCP server (inside container) provides scheduling tools
...
**MicroClaw** - A reference to Clawdbot (now OpenClaw).
