...
> - Triggered only from WhatsApp (e.g., "@Jarvis check my email" or "@Jarvis send an email to...")
...
>
> `@Jarvis check my recent emails`
>
> Or:
>
> `@Jarvis list my Gmail labels`
...
> - Emails with a subject starting with a keyword (e.g., "[Jarvis]")
...
Complete all Tool Mode steps above before continuing. Verify Gmail tools work by having the user test `@Jarvis check my recent emails`.
